...
type Task struct {
	...
	// SecretMappings specifies a mapping from secret IDs present in the TaskSpec,
	// which are to be replaced by internal secrets in order to support assigning
	// different secret values to different tasks of the same service.
	SecretMappings map[string]string `protobuf:"bytes,16,rep,name=secret_mappings,json=secretMappings" json:"secret_mappings,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *Task) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.SecretMappings != nil {
		m.SecretMappings = make(map[string]string, len(o.SecretMappings))
		for k, v := range o.SecretMappings {
			m.SecretMappings[k] = v
		}
	}
...
func (m *Task) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.SecretMappings) > 0 {
		for k, _ := range m.SecretMappings {
			dAtA[i] = 0x82
			i++
			dAtA[i] = 0x1
			i++
			v := m.SecretMappings[k]
...
func (m *Task) Size() (n int) {
	...
	if len(m.SecretMappings) > 0 {
		for k, v := range m.SecretMappings {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovObjects(uint64(len(k))) + 1 + len(v) + sovObjects(uint64(len(v)))
			n += mapEntrySize + 2 + sovObjects(uint64(mapEntrySize))
		}
	}
	return n
}
...
func (this *Task) String() string {
	...
	keysForSecretMappings := make([]string, 0, len(this.SecretMappings))
	for k, _ := range this.SecretMappings {
		keysForSecretMappings = append(keysForSecretMappings, k)
	}
	sortkeys.Strings(keysForSecretMappings)
	mapStringForSecretMappings := "map[string]string{"
	for _, k := range keysForSecretMappings {
		mapStringForSecretMappings += fmt.Sprintf("%v: %v,", k, this.SecretMappings[k])
	}
	mapStringForSecretMappings += "}"
	s := strings.Join([]string{`&Task{`,
		...
		`SecretMappings:` + mapStringForSecretMappings + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Task) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecretMappings", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SecretMappings == nil {
				m.SecretMappings = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.SecretMappings[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipObjects(dAtA[iNdEx:])
...
var fileDescriptorObjects = []byte{
	...
	,
}
